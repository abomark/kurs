"""Individuell oppgave 5 – modul 19 (Refleksjon).
...
def main() -> None:
    crumb(["Kursmoduler", "19 · Individuell oppgave 5"])
    st.title("🪞 Individuell oppgave 5")
    st.caption("Modul 19 · Refleksjon: sammenlign agentens output med din egen.")
    st.divider()
    ...
    st.divider()
    next_module_cta_for("pages/agents_md.py")

"""Individuell oppgave 5 – modul 20 (Refleksjon).
...
def main() -> None:
    crumb(["Kursmoduler", "20 · Individuell oppgave 5"])
    st.title("🪞 Individuell oppgave 5")
    st.caption("Modul 20 · Refleksjon: sammenlign agentens output med din egen.")
    st.divider()

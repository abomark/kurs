"""Individuell oppgave 3 – modul 15 (Datakvalitetssjekk).
...
def main() -> None:
    crumb(["Kursmoduler", "15 · Individuell oppgave 3"])
    st.title("🩺 Individuell oppgave 3")
    st.caption("Modul 15 · Hands-on: datakvalitetssjekk med Cortex Code.")
    st.divider()

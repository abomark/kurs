"""Individuell oppgave 3 – modul 22 (Datakvalitetssjekk).
...
def main() -> None:
    crumb(["Kursmoduler", "26 · Individuell oppgave 3"])
    st.title("Individuell oppgave 3")
    st.caption("Modul 26 · Hands-on: datakvalitetssjekk med Cortex Code.")
    st.divider()
